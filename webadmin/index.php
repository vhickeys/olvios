...
// $packages_count = $record->countRecords("packages") ?? null;
...
<div class="content-body">
    ...
    <div class="page-titles">
        ...
        <a class="text-primary fs-13" href="create-category.php" aria-controls="offcanvasExample1">+ Add Portfolio Category</a>
    </div>
                        ...
                        <div class="card">
                            <div class="card-body depostit-card">
                                <div class="depostit-card-media d-flex justify-content-between style-1">
                                    <div>
                                        <h6>Total Portfolio Category</h6>
                                        <h3><?php echo $packages_count ?? "No Data" ?></h3>
                                    </div>
                                    <div class="icon-box bg-primary-light">
