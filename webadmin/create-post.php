                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="classes/process.php?action=create-post" method="POST" enctype="multipart/form-data">

                                <div class="mb-3 row">
                                    <label class="col-sm-3 col-form-label">Name:</label>
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control" placeholder="Enter Title of Blog Post">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="category" class="form-control" placeholder="Enter Category of Blog Post">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control" name="caption" placeholder="Enter Caption of Blog Post" rows="3" id=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control" name="quote" placeholder="Enter Quotes of Blog Post" rows="3" id=""></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="my-3 row justify-content-center">
                                <div class="col-sm-12">
                                    <button type="submit" name="submit-post" class="btn btn-primary w-100">Publish Blog Post</button>
                                </div>
                            </div>
