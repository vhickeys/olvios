                        ...
                        <div class="basic-form">
                            <form action="classes/process.php?action=create-product" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control" name="caption" placeholder="Enter Caption of Product" rows="3" id=""></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="price" class="form-control" placeholder="Enter Price of Product">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="product_url" class="form-control" placeholder="Product URL (Link to see the Product live)">
                                    </div>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="my-3 row justify-content-center">
                                <div class="col-sm-12">
                                    <button type="submit" name="submit-product" class="btn btn-primary w-100">Create a New
                                        Product</button>
                                </div>
                            </div>
