                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            <form action="classes/process.php?action=edit-post" method="POST"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="title" class="form-control"
                                            value="<?= $post['title'] ?>" placeholder="Enter Title of Blog Post">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="category" class="form-control"
                                            value="<?= $post['category'] ?>" placeholder="Enter Category of Blog Post">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control" name="caption"
                                            placeholder="Enter Caption of Blog Post" rows="3"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control" name="quote"
                                            placeholder="Enter Quotes of Blog Post" rows="3"
                                            id=""><?= $post['quote'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="quoted_by" value="<?= $post['quoted_by'] ?>" class="form-control"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea class="form-txtarea form-control tiny" name="description" rows="8"
                                            placeholder="Blog Post Content"><?= $post['description'] ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-3">
                                        <input type="hidden" name="old_image"
                                            value="<?= $post['image'] ?? 'No Data' ?>">
                                        <img src="../assets/images/posts/<?= $post['image'] ?: 'default.png' ?>"
                                            class="img-fluid" alt="<?= $post['title'] ?? 'No Data' ?>">
                                    </div>
                                </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="basic-form">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="video_url" value="<?= $post['video_url'] ?>" class="form-control"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-txtarea form-control" name="conclusion"
                                        placeholder="Conclusion (If Available)" rows="3" id=""><?= $post['conclusion'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="meta_title" class="form-control"
                                        value="<?= $post['meta_title'] ?>" placeholder="Meta Title">
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-txtarea form-control" name="meta_keywords"
                                        placeholder="Meta Keywords" rows="3"
                                        id=""><?= $post['meta_keywords'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-txtarea form-control" name="meta_description"
                                        ...
                                        id=""><?= $post['meta_description'] ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="form-check">
                                        <input class="form-check-input" <?= $post['status'] == '1' ? 'checked' : '' ?>
                            ...
                            <div class="my-3 row justify-content-center">
                                <div class="col-sm-12">
                                    <button type="submit" name="update-post" class="btn btn-primary w-100">Update Blog
                                        Post</button>
                                </div>
                            </div>
