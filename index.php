...
?>
    <div class="main-content w-100">
      ...
      <div
        ...
        <a href="index-2.html" class="side-icon bgn2-color brn4">
        ...
        <div class="header-bottom-menu w-full">
          <ul class="d-flex gap-1 align-items-center justify-content-between">
            <li class="rounded-3 bg1-color">
              <a href="index-2.html" class="d-flex align-items-center gap-2 n11-color fs-eight p-2">
          ...
          <div class="d-flex flex-wrap gap-10 gap-md-15 align-items-center justify-content-between">
            <div class="banner-content">
              ...
              <p class="fs-seven n5-color">
                ...
                Explore my
                <a href="blog.html" class="p1-color"> blog</a>,<a href="portfolio.html" class="p1-color">
                  project portfolio</a>
      ...
      <section class="pt-120 pb-120">
        <div class="container">
          <div class="d-flex gap-3 flex-wrap flex-xxl-nowrap justify-content-between align-items-end pb-60">
            ...
            <a href="price.html" data-aos="zoom-in-right"
      ...
      <section class="pt-120 pb-120">
        <div class="container">
          <div class="d-flex gap-3 flex-wrap flex-xxl-nowrap justify-content-between align-items-end mb-8 mb-md-15">
            ...
            <a data-aos="zoom-in-right" href="blog.html"
      ...
      <section
        ...
        <span class="fs-eight fw-medium n5-color order-sm-2">Designed by
          <a href="https://themeforest.net/user/uiaxis" class="fs-eight fw-medium n5-color">UIAXIS</a></span>
        <span class="fs-eight fw-medium n5-color order-sm-1">Copyright © 2024
          <a href="index-2.html" class="fs-eight fw-medium n5-color">Portfolify</a>. All Rights Reserved.</span>
      </section>
      <!-- footer section end -->
    </div>
<?php
